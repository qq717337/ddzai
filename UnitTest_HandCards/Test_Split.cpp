...
namespace UnitTest_Split
{
	...
	public:
		...
		TEST_METHOD(TestNewGame)
		{
			...
			//CardSet *opt=new CardSet();
			//opt->PlayerCardSet[0] = new HandCards(CardVector{ 0x13,0x43,0x34,0x44,0x36,0x17,0x38,0x19,0x29,0x49,0x2a,0x3c,0x1d,0x2d,0x4d,0x1e,0x2e,0x4e,0x3f,0x1 });
			//opt->PlayerCardSet[1] = new HandCards(CardVector{ 0x14,0x15,0x35,0x26,0x46,0x18,0x28,0x48,0x3a,0x1b,0x2b,0x3b,0x2c,0x4c,0x3e,0x1f,0x2 });
			//opt->PlayerCardSet[2] = new HandCards(CardVector{ 0x23,0x33,0x24,0x25,0x45,0x16,0x27,0x37,0x47,0x39,0x1a,0x4a,0x4b,0x1c,0x3d,0x2f,0x4f });
			//
			//cv->ShowCard(opt);
			GameTable table(*opt);
